  ...
  return (
    <div className="text-white flex justify-center items-center pb-16">
      <div className="flex flex-col justify-center items-center">
        ...
        {savedData.length === 0 ? (
          <p className="text-xl">No created QR Codes detected</p>
        ) : (
          <div className="flex flex-col justify-center items-center gap-4">
            {savedData.map((item, index) => (
              <div
                key={index}
                className="flex flex-col rounded-lg border-2 bg-[#bb6eff] w-fit justify-center text-center p-3 items-center"
              >
